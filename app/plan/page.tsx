      ...
      <div className="overflow-hidden bg-white">
        <header className="sticky top-0 z-40 border-b border-black/[0.06] bg-white/95 backdrop-blur-xl">
          <div className="grid h-[68px] grid-cols-[44px_1fr_44px] items-center px-4">
            <Link
              href="/result"
              aria-label="診断結果へ戻る"
              className="flex h-10 w-10 items-center justify-center rounded-full transition hover:bg-black/[0.05]"
            >
              <Icon
                name="arrowLeft"
        ...
        <div className="pb-32">
          <section className="px-5 pb-6 pt-7 text-center">
            ...
            <p className="mx-auto mt-2 max-w-[340px] text-[12px] leading-5 text-neutral-500">
              期限や週区切りはありません。優先順位の高い項目から、自分のペースで進めてください。
            </p>
          </section>

          <section className="mx-4 rounded-[24px] bg-[#111111] p-5 text-white shadow-[0_18px_45px_rgba(17,17,17,0.22)]">
                    ...
                    {opened && (
                      <div className="border-t border-black/10 bg-white px-4 py-4">
                        ...
                        {task.href && (
                          <Link
                            href={task.href}
                            className="mt-4 flex min-h-11 items-center justify-between rounded-[11px] bg-black px-4 text-[11px] font-black text-white"
                          >
                            {task.hrefLabel}
          ...
          {progress === 100 && (
            <section className="mx-4 mt-6 rounded-[20px] border border-[#FFD400]/40 bg-[#FFF9D9] p-5 text-center">
              ...
              <Link
                href="/upload"
                className="mt-4 flex min-h-12 items-center justify-center rounded-[12px] bg-black text-[12px] font-black text-white"
              >
                もう一度診断する
              </Link>
            </section>
          ...
          <button
            ...
            className="mx-auto mt-6 flex items-center gap-2 text-[10px] font-black text-neutral-400"
          >
            <Icon
              name="reset"
              className="h-4 w-4"
